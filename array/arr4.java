...
//        1st break the array in 2 array (before k elemnt and after k elemnt) eg.(for arr {1,2,3,4} and {5,6,7})
//        rotate both arrays indiidually ({4,3,2,1} and {7,6,5})
//        rotate full array individually {5,6,7,1,2,3,4}
//
